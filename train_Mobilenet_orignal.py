...
def _main():
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,load_pretrained=False,#default "False"
                             #weights_path='logs/Mobilenet/trained_weights_final.h5',
...
#     num_train = len(lines) - num_val
    ...
    if True:
        ...
        model.save_weights(log_dir + 'trained_weights_he_0824.h5')
    ...
    if True:
        ...
        model.save_weights(log_dir + 'trained_weights_stage2_0824.h5')
